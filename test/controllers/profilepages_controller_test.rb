...
class ProfilepagesControllerTest < ActionController::TestCase
  ...
  test "should create profilepage" do
    assert_difference('Profilepage.count') do
      post :create, profilepage: { description: @profilepage.description, name: @profilepage.name, string,: @profilepage.string,, user_id: @profilepage.user_id }
    end
  ...
  test "should update profilepage" do
    patch :update, id: @profilepage, profilepage: { description: @profilepage.description, name: @profilepage.name, string,: @profilepage.string,, user_id: @profilepage.user_id }
    assert_redirected_to profilepage_path(assigns(:profilepage))
  end
